...
//            [_gestureContentView addGestureRecognizer:self.gesture];
//        } else {
...
//- (void)setGestureContentView:(UIView *)gestureContentView {
//    _gestureContentView = gestureContentView;
//    if (!_gestureContentView) {
//        return;
//    }
//    if (_dragable) {
...
{
    if (self.direction == ZFModalTransitonDirectionBottom || (otherGestureRecognizer.view && [otherGestureRecognizer.view isKindOfClass:[NSClassFromString(@"YomoShortVideoCommentTableView") class]])) {
        return YES;
    }
    return NO;
}
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRequireFailureOfGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    if ((self.gestureRecognizerToFailPan && otherGestureRecognizer && self.gestureRecognizerToFailPan == otherGestureRecognizer) || (otherGestureRecognizer.view && [otherGestureRecognizer.view isKindOfClass:[NSClassFromString(@"YomoShortVideoCommentTableView") class]])) {
        return YES;
    }
