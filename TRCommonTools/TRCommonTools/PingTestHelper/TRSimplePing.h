...
//  Pods
//
//  Created by xksTracky on 2017/11/20.
//
/*
...
@protocol TRSimplePingDelegate;

/*! Controls the IP address version used by SimplePing instances.
 */

typedef NS_ENUM(NSInteger, TRSimplePingAddressStyle) {
    TRSimplePingAddressStyleAny,          ///< Use the first IPv4 or IPv6 address found; the default.
    TRSimplePingAddressStyleICMPv4,       ///< Use the first IPv4 address found.
    TRSimplePingAddressStyleICMPv6        ///< Use the first IPv6 address found.
};
...
@interface TRSimplePing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<TRSimplePingDelegate> delegate;

/*! Controls the IP address version used by the object.
 *  \details You should set this value before starting the object.
 */

@property (nonatomic, assign, readwrite) TRSimplePingAddressStyle addressStyle;
...
@protocol TRSimplePingDelegate <NSObject>
